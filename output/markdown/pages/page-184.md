...
- 자동화된 결정 및 프로파일링 관련 권리(rights in relation to automated decision making and profiling) 삭제권(삭제요청권)은 기존 GDPR 초안의 잊힐 권리(the right to forgotten)에서 명칭이 바뀐 것으로 삭제권와 데이터 이동권은 정보주체의 권리를 강화시키는 항목에 해당된다.
...
- 위반으로 인해 직간접적으로 얻은 금전적 이익 또는 회피한 손실 'GDPR 규정을 위반하는 경우, 사안의 경중에 따라 최대 전 세계 매출액의 4% 또는 2000만 유로 중 높은 금액의 과징금 부과 자료: 한국인터넷진흥원(KISA) BUSINESS watch
